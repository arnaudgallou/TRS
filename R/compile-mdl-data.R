...
#' @param rename_bioclim If `TRUE` (the default), will rename "bio_1", "bio_2",
#'   "bio_4" and "bio_12" as "mat", "dtr", "ts" and "ap", respectively.
...
compile_mdl_data <- function(
  ...
  data <- all_data <- tidyr::drop_na(data, starts_with("bio")) |>
    mutate(sp_range = {
