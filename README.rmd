---
title: The Temperature Range Squeeze hypothesis
output:
  github_document:
    toc: true
    toc_depth: 2
...
Below are the different R packages required to run the code in this repository:

* [tidyverse](https://www.tidyverse.org)
* [TRS.utilities](https://github.com/arnaudgallou/TRS.utilities/)
* [glue](https://glue.tidyverse.org)
* [bayesplot](https://mc-stan.org/bayesplot/) (only for model diagnostics)
...
In addition, you will need to have [JAGS](https://sourceforge.net/projects/mcmc-jags/) installed on your machine.
